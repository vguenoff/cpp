...
int main() {
  char text[16] = {'C', '+', '+', ' ', 'P', 'r', 'o', 'g',
                   'r', 'a', 'm', 'm', 'i', 'n', 'g', '\0'};
  char sameText[] = {'C', '+', '+', ' ', 'P', 'r', 'o', 'g',
                     'r', 'a', 'm', 'm', 'i', 'n', 'g', 0};
  ...
  char arrWithNullTerminatorInMiddle[] = {'p',  'r', 'i', 'n', 't', 'e', 'd',
                                          '\0', 'n', 'o', 't', ' ', 'p', 'r',
                                          'i',  'n', 't', 'e', 'd'};
  ...
  // more there will be no room for the null terminator and behavior is
  // undefined
  cin >> input;
